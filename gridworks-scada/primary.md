...
| [`explorations/`](explorations/) | Cross-cutting design questions (liveness/SLA, deeds, transport, sema-style, interfaces). |
...
The richer `research/` substructure (components / findings) is a
