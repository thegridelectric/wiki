...
- **sema** — [`designs/snapshot-drift-check.md`](sema/designs/snapshot-drift-check.md) (consumer CI proves a vendored sema snapshot is byte-identical to a rebuild from its pinned sema commit; pin beside the snapshot, never inside it; gwbase first; Draft, OPS-536)
