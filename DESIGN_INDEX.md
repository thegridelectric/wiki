...
- **gridworks-weather-forecast** — [`designs/stand-up-weather-forecast/`](gridworks-weather-forecast/designs/stand-up-weather-forecast/primary.md) (stand up gwwf as the fleet's production weather source: CURRENT + forecast weather through a fresh gw.weather.* vocabulary — channel/forecast-channel/location `.gt` words seeded in the gridworks-weather DB, competing named forecasters, push-first pull-on-miss delivery; legacy weather + weather.forecast words retire, historical S3 record imported as sad-duck 1-slice hindcast channels; hub-and-spoke: vocabulary / delivery / journalkeeper-and-history / evidence; Linear OPS-436)
