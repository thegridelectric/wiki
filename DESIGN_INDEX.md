...
- **gridworks-scada** — [`designs/spruce-egauge-register-map.md`](gridworks-scada/designs/spruce-egauge-register-map.md) (fix the spruce eGauge HP power registers reading 0 through a working pipeline: pin the device's edited register map, correct the gens, land the CTs; Linear OPS-483)
