...
- **gridworks-scada** — [`designs/sieg-summer-posture.md`](gridworks-scada/designs/sieg-summer-posture.md) (stub: sieg valve defaults OPEN in summer/Standby, reversing heating-season HP-off-closed; check maple now; Linear OPS-395)
