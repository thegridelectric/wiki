...
- **experiments** — [`designs/semafy-experiments.md`](experiments/designs/semafy-experiments.md) (experiment results become validated sema instances, vocabulary added by sub-folder; ads-noise re-run is the pilot; display depends on harmonize-units; Linear OPS-490)
