...
- **cross-cutting** — [`designs/platform-drift-corrector.md`](designs/platform-drift-corrector.md) (auto-correct platform-box drift from pushed-main: tiered pull/quarantine, pin ledger, Telegram via alert-manager; org branch invariant as policy preamble; Draft, OPS-515)
- **flo** — [`flo/designs/flo-as-a-service.md`](flo/designs/flo-as-a-service.md) (FLO compute out of the LTN process into its own gwbase service + box; LTN boxes sized LTN-only; opening experiment = measured FLO build peak RSS; gwsproto LTN straddle until the proactor port; Draft, OPS-514)
...
- **starter-scripts** — [`designs/ct-measurement-chain/primary.md`](starter-scripts/designs/ct-measurement-chain/primary.md) (the gw108 CT channels as a measured chain: a published waveform-capture word, the CT vocabulary, bench runs from the starter-scripts venv; scada actor after the spruce jumper)
