...
> [OPS-386](https://linear.app/gridworks/issue/OPS-386)). The mechanism and plan for **which message types JournalKeeper
...
> new `ally.inactive` word moved to **[OPS-317](https://linear.app/gridworks/issue/OPS-317) (scada-health-diagnostics)** —
